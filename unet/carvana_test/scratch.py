...
def main():
    ...
    """
    pred_mask_tile_dir = "/home/pcuriel/data/aiptasia/code/unet/carvana_test/experiments/23-Oct-2024_1828_40/mask_arrays"    
    pred_mask_tile_files = natsorted(os.listdir(pred_mask_tile_dir))
    pred_img_dir = "/home/pcuriel/data/aiptasia/code/unet/carvana_test/experiments/23-Oct-2024_1828_40/mask_images"
    os.makedirs(pred_img_dir, exist_ok=True)

    gt_mask_dir = "/home/pcuriel/data/aiptasia/image_data/carvana_data/test_masks"
    gt_mask_files = natsorted(os.listdir(gt_mask_dir))
    gt_img_dir = "/home/pcuriel/data/aiptasia/image_data/carvana_data/test_masks" #note: .gif (bc of fucking course it is)
    ...
    file_iter = enumerate(pred_mask_tile_files)
